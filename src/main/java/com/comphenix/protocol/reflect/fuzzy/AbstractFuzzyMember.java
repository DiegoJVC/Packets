...
public abstract class AbstractFuzzyMember<T extends Member> extends AbstractFuzzyMatcher<T> {
	...
	/**
	 * Retrieve a bit field of every {@link Modifier Modifier} that is required for the member to match.
	...
	/**
	 * Retrieve a bit field of every {@link Modifier Modifier} that must not be present for the member to match.
